...
?>
        ...
        <!-- Services-->
        <section class="page-section" id="services" data-aos="zoom-in" data-aos-duration="2000">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Serviceso</h2>
            ...
            <div class="container" data-aos="zoom-in" data-aos-duration="2000">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <!-- Portfolio item 1-->
                        <div class="portfolio-item" data-aos="fade-down" data-aos-duration="2000">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo get_template_directory_uri()?>/assets/img/logos/microsoft.svg" alt="..." /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo get_template_directory_uri()?>/assets/img/logos/google.svg" alt="..." /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo get_template_directory_uri()?>/assets/img/logos/facebook.svg" alt="..." /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="<?php echo get_template_directory_uri()?>/assets/img/logos/ibm.svg" alt="..." /></a>
                    </div>
                </div>
            </div>
        </div>
